	...
	return (
		<Paper className="flex flex-col flex-auto shadow rounded-2xl overflow-hidden">
			...
			<div className="text-center mt-8">
				...
				<Typography className="text-lg font-medium text-red-600">Active learner</Typography>
			</div>
			<Typography
				className="flex items-baseline justify-center w-full mt-20 mb-24"
				color="text.secondary"
			>
				<span className="truncate">Inactive learner</span>:<b className="px-8">{data.inActiveLearnerNumber}</b>
			</Typography>
		</Paper>
	);
}
