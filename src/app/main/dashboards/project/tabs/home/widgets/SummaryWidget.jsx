	...
	return (
		<Paper className="flex flex-col flex-auto shadow rounded-2xl overflow-hidden">
			...
			<div className="text-center mt-8">
				...
				<Typography className="text-lg font-medium text-blue-600 dark:text-blue-500">Active course</Typography>
			</div>
			<Typography
				className="flex items-baseline justify-center w-full mt-20 mb-24"
				color="text.secondary"
			>
				<span className="truncate">Inactive course</span>:
				<b className="px-8">{data.inActiveCourseNumber}</b>
			</Typography>
		</Paper>
	);
}
